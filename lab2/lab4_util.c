...
/* 
Executes a command in a child process using a shell (/bin/sh).
Takes a null-terminated string to be passed to the shell to execute
*/
...
void simple_strcpy(char dest[], const char source[]) 
{
    int i = 0;
